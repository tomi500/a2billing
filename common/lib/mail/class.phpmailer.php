 ...
 */
  ...
  */
  ...
  public function Base64EncodeWrapMB($str) {
    ...
    $encoded = mb_substr($encoded, 0, -strlen($this->LE));
    return $encoded;
  }
    ...
    if(isset($images[2])) {
      foreach($images[2] as $i => $url) {
        ...
        if (!preg_match('#^[A-z]+://#', $url)) {
          ...
          if ( strlen($basedir) > 1 && mb_substr($basedir, -1) != '/') { $basedir .= '/'; }
          if ( strlen($directory) > 1 && mb_substr($directory, -1) != '/') { $directory .= '/'; }
  ...
  */
  ...
  public function DKIM_BodyC($body) {
    ...
    while (mb_substr($body, strlen($body) - 4, 4) == "\r\n\r\n") {
      $body = mb_substr($body, 0, strlen($body) - 2);
    }
    return $body;
  }
