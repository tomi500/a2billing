...
<!-- ** ** ** ** ** Part for the research - ** ** ** ** ** -->
	<center>
		...
		<FORM METHOD=POST ACTION="<?php echo $PHP_SELF?>?s=<?php echo $processed['s']?>&t=<?php echo $processed['t']?>&order=<?php echo $processed['order']?>&sens=<?php echo $processed['sens']?>&current_page=<?php echo $processed['current_page']?>">
			...
			<tr>
				...
				<td class="bgcolor_005" align="center">
					...
					<?php if(isset($_SESSION[$this->FG_FILTER_SEARCH_SESSION_NAME]) && strlen($_SESSION[$this->FG_FILTER_SEARCH_SESSION_NAME])>10 ){ ?>
                    	- <a href="<?php echo $PHP_SELF?>?cancelsearch=true"><font color="red"><b><img src="<?php echo KICON_PATH; ?>/button_cancel.gif" height="16"> Cancel Search</b></font></a>&nbsp;
						<?php if ($this -> FG_FILTER_SEARCH_DELETE_ALL){ ?>
							- <a href="<?php echo $PHP_SELF?>?deleteselected=true" onclick="return confirm('<?php echo "Are you sure to delete ".$this -> FG_NB_RECORD." selected records?";?>');"><font color="red"><b>Delete All</b></font></a>
						<?php } ?>
                    <?php } ?>
	  			</td>
    		</tr>
