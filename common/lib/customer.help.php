...
if (SHOW_HELP) {
	...
	$CC_help_ringuplist = create_help("<b>Список номеров периодического дозвона.</b><br>В колонке 'ПОСЛЕДНЯЯ АКТИВНОСТЬ' синим цветом обозначен простаивающий дозвон, зелёным - действующий, красным - завершённый.<br>Нажав на 'НОМЕР', откроется статистика звонков на этот номер за текущий месяц.",$credit_cur,$limit_cur);
