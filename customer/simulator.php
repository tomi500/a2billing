...
$arr_ratecard = array('idtariffgroup', 'cc_tariffgroup_plan.idtariffplan', 'tariffname', gettext("Destination"), 'cc_ratecard.id' , 'dialprefix', 'destination', 'buyrate', 'buyrateinitblock', 'buyrateincrement', gettext("Cost per minute"), 'initblock', 'billingblock', 'connectcharge', 'disconnectcharge', 'stepchargea', 'chargea', 'timechargea', 'billingblocka', 'stepchargeb', 'chargeb', 'timechargeb', 'billingblockb', 'stepchargec', 'chargec', 'timechargec', 'billingblockc', 'tp_id_trunk', 'tp_trunk', 'providertech', 'tp_providerip', 'tp_removeprefix');
	  ...
	  <table width="65%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<TR>
          <td height="15" class="bgcolor_005" style="padding-left: 5px; padding-right: 3px;" colspan="2">
					<font class="fontstyle_008"><?php echo gettext("We found several destinations:");?></font></td>
        </TR>
		<?php } ?>
		<?php 
