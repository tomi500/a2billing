...
<tr>
	...
	<td width="50%">
	<font class="fontstyle_002"><?php echo gettext("ADRESS");?> :</font> <font class="fontstyle_007"><?php echo $customer_info[4]; ?></font>
...
<tr>
	<td align="center">
		...
		<tr>
			...
			<td width="50%" nowrap="nowrap">
			<br><font class="fontstyle_002"><?php echo gettext("BALANCE REMAINING");?> :</font><font class="fontstyle_007"> <?php display_refill_money($credit_cur,gettext($customer_info[22])); ?> </font>
			<br><br>
			</td>
			<?php
